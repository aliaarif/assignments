<template>
  ...
  >
    ...
    >
      <li
        :class="this.$route.fullPath == '/' || this.$route.fullPath == '/dashboard' ? 'bold open active' : 'bold open' "
      >
        <router-link
      ...
      <li :class="this.$route.fullPath == '/dashboard/my-contacts' ? 'active' : '' ">
        <router-link
          :class="this.$route.fullPath == '/dashboard/my-contacts' ? this.$parent.menu_color : '' "
          to="/dashboard/my-contacts"
          data-i18n
        >
          <i
            class="material-icons"
            v-if="this.$route.fullPath == '/dashboard/my-contacts'"
      ...
      <li :class="this.$route.fullPath == '/dashboard/profile' ? 'active' : '' ">
        <router-link
