        ...
        <div class="navbar navbar-fixed">
          <nav :class="this.$parent.navbar_color">
            <div class="nav-wrapper">
              <div class="header-search-wrapper hide-on-med-and-down">
                ...
                type="text"
                name="search"
                :placeholder="'You are logged in as '+this.$parent.user.role"
                />
              </div>
          ...
          <li>
            ...
            <span class="avatar-status avatar-online">
              <img :src="bURL+this.$parent.user.avatar" alt="avatar" />
              <i></i>
            </span>
          </a>
        </li>
    ...
    <ul class="dropdown-content" id="translation-dropdown">
      <li>
        <a class="grey-text text-darken-1" href="javascript:;">
    ...
    <ul class="dropdown-content" id="notifications-dropdown">
      ...
      <li class="divider"></li>
      <li>
        <a class="grey-text text-darken-2" href="javascript:;">
