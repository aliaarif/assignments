<template>
  <div v-if="mainContentsViews == 'Student'">Student</div>
  <div v-else-if="mainContentsViews == 'Teacher'">Teacher</div>
  <div v-else>
        ...
        <div class="col s12 m4 l3">
          ...
          <div class="row mb-10" v-if="attendanceType == 'Student'">
            <div class="col s12">
              ...
              <label class="mt-1" v-for="standard in standards">
                <input
                  type="checkbox"
                  ...
                  <table class="subscription-table responsive-table highlight">
                    <thead>
                      <tr>
                        ...
                        <th class="center">
                          <span class="badge yellow lighten-5 yellow-text text-accent-4">Half Day</span>
                        </th>
                        <th class="center">
                          <span class="badge red lighten-5 red-text text-accent-4">Absent</span>
                        </th>
                      </tr>
                    </thead>
                    <tbody>
...
export default {
  ...
  data: () => {
    return {
      user: localStorage.getItem("user")
        ...
        : {},
      attendanceDate: localStorage.getItem("attendanceDate")
        ? localStorage.getItem("attendanceDate")
        : new Date(),
      attendanceType: localStorage.getItem("attendanceType")
        ? localStorage.getItem("attendanceType")
        : "Staff",
      standard: localStorage.getItem("standard")
        ? localStorage.getItem("standard")
        : 1,
      checkedStandard: localStorage.getItem("standard")
        ? localStorage.getItem("standard")
        : 1,
      presentStatus: "",
      userCode: "",
      ...
      listAttendances: [],
      bURL: window.bURL,
      mainContentsViews: JSON.parse(localStorage.getItem("user")).role
  ...
  watch: {
    presentStatus: function(n, o) {
      ...
      if (
        ...
        this.userAttendanceDate == this.attendanceDate
      ) {
        //this.presentStatus = 'Present';
  ...
  methods: {
    ...
    applyFilters: function(filters) {
      ...
      //alert(3);
      axios
        .post(`/api/show-attendance`, { filters: filters })
        .then(res => {
